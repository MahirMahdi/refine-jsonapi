...
nock("https://api.fake-json-api.refine.dev:443", {
  encodedQueryParams: true,
})
  .get("/users")
  .query({ sort: "id" }) //ascending order
  .reply(
    200,
    {
      data: [
...
nock("https://api.fake-json-api.refine.dev:443", {
  ...
  .reply(
    ...
    [
      ...
      "Location",
      "Location",
      "http://api.fake-json-api.refine.dev/users/51",
      "X-Content-Type-Options",
      "nosniff",
      "ETag",
...
nock("https://api.fake-json-api.refine.dev:443", {
  ...
  .get("/users")
  .query({ "filter[email][eq]": "tiana_gleason63%40hotmail.com" })
  .reply(
    200,
    {
      data: [
